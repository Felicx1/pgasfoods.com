  ...
  stripe
    ...
    .then(function(result) {
      if (result.error) {
        ...
        loc_redirect(false); // testing redirect from  js
...
var orderComplete = function(clientSecret) {
  stripe.retrievePaymentIntent(clientSecret).then(function(result) {
    ...
    loc_redirect(true); // testing redirect from js success
...
function loc_redirect(e){

    if(e){
        document.location.href = '/order/checkout/success';
    }else{
        document.location.href = '/order/checkout/cancel';
    }
}
