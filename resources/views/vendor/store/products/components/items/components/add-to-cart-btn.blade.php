...
@endif
    ...
    @if(_value($product, 'conditions', 3) != 3)
    <a href="javascript:;" class="add-cart-btn" data-tooltip="Add to cart"> <span class="icon_cart_alt add-to-cart add_to_cart"></span></a>
    @endif
    <a href="javascript:;" class="add-cart-btn" style="display:none" data-tooltip="Quick view" data-view-url='{{ route('store.get.product.quick.view', ["id"=>_value($product, "id")]) }}' data-view-id='{{ _value($product, "id")  }}' data-toggle="modal" data-target="#quick-view-modal-container"> <span class="icon_search"></span> </a>
