...
<div class="col-lg-2 col-md-4 col-sm-6 filtr-item wrap-items" data-category="1, 3, 4" data-sort="Busy streets" id="{{ $size_price->products_id ?? '0' }}|{{ $size_price->size_id ?? '0' }}"
